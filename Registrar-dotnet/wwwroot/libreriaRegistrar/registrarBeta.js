function RegistroCliente(reg_id, creator_id){
    URL = `https://localhost:5001/Clientes/RegistroCliente?reg_id=${reg_id}&creator_id=${creator_id}`;
...
function LoginCliente(reg_id, creator_id){
    URL = `https://localhost:5001/Clientes/LoginCliente?reg_id=${reg_id}&creator_id=${creator_id}`;
