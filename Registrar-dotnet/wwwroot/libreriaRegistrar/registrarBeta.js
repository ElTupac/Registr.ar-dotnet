function RegistroCliente(reg_id, creator_id){
    URL = `https://registrar-tupac.herokuapp.com/Clientes/RegistroCliente?reg_id=${reg_id}&creator_id=${creator_id}`;
...
function LoginCliente(reg_id, creator_id){
    URL = `https://registrar-tupac.herokuapp.com/Clientes/LoginCliente?reg_id=${reg_id}&creator_id=${creator_id}`;
